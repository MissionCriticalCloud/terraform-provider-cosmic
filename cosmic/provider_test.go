...
// An IP address in the range of the CLOUDSTACK_VPC_NETWORK_CIDR
var CLOUDSTACK_VPC_NETWORK_IPADDRESS = os.Getenv("CLOUDSTACK_VPC_NETWORK_IPADDRESS")
...
var CLOUDSTACK_PRIVNW_CIDR = os.Getenv("CLOUDSTACK_PRIVNW_CIDR")
var CLOUDSTACK_PRIVNW_OFFERING = os.Getenv("CLOUDSTACK_PRIVNW_OFFERING")
